...
public class ChartController {
    ...
    @FXML
    private Label sumOfDistanceLabel;
    private Stage stage;
    ...
    public void changeChartAndData(List<double[]> data, List<double[]> centroids, double sumOfDistance, int[] correlation) {
        updateChart(data, correlation);
        updateDataLabels(centroids, sumOfDistance);
    }

    private void updateDataLabels(List<double[]> centroids, double sumOfDistance) {
        StringBuilder text = new StringBuilder("Centroids: ");
        ...
        centroidsLabel.setText(text.toString());
        sumOfDistanceLabel.setText(String.format("Sum of distance: %.3f",sumOfDistance));
    }
    ...
    public void start(KMeans kmeans) {
        kmeans.setChartController(this);
        kmeans.start();
    }
}
