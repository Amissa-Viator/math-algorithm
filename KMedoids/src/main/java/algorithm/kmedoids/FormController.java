...
public class FormController {
    ...
    void handleGetInfo(ActionEvent event) {
        ...
        KMedoids kMedoids = new KMedoids(clustersAmount, isEuclideanMetricSelected, idManhattanMetricSelected, filePath);
        switchScenes(kMedoids);
    }

    private void switchScenes(KMedoids kMedoids) {
        try {
